...
import {parseAllowedFontSize} from '../../utils/fontSize';
import {parseAllowedColor} from '../../utils/colorPicker';
...
export const PlaygroundRichTextImportExtension = defineExtension({
  ...
  name: '@lexical/kalliope/RichTextImport',
});
